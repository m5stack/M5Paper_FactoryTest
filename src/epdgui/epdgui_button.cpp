...
EPDGUI_Button::EPDGUI_Button(String label, int16_t x, int16_t y, int16_t w,
                             int16_t h, uint32_t style)
    : EPDGUI_Base(x, y, w, h) {
...
void EPDGUI_Button::Bind(int16_t event,
...
void EPDGUI_Button::setBMPButton(String label_l, String label_r,
                                 const uint8_t* bmp32x32) {
