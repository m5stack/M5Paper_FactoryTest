...
Frame_Keyboard::Frame_Keyboard(bool isHorizontal) : Frame_Base() {
    ...
    key_textsize_plus->AddArgs(EPDGUI_Button::EVENT_RELEASED, 0,
                               (void *)inputbox);
    key_textsize_plus->AddArgs(EPDGUI_Button::EVENT_RELEASED, 1,
                               (void *)key_textsize_reset);
    key_textsize_plus->Bind(EPDGUI_Button::EVENT_RELEASED,
                            key_textsize_plus_cb);
    key_textsize_reset->AddArgs(EPDGUI_Button::EVENT_RELEASED, 0,
                                (void *)inputbox);
    key_textsize_reset->AddArgs(EPDGUI_Button::EVENT_RELEASED, 1,
                                (void *)key_textsize_reset);
    key_textsize_reset->Bind(EPDGUI_Button::EVENT_RELEASED,
                             key_textsize_reset_cb);
    key_textsize_minus->AddArgs(EPDGUI_Button::EVENT_RELEASED, 0,
                                (void *)inputbox);
    key_textsize_minus->AddArgs(EPDGUI_Button::EVENT_RELEASED, 1,
                                (void *)key_textsize_reset);
